        	...
        	<div class="theme-navigate">
				<div class="right">
					<a href="#" class="easyui-menubutton theme-navigate-user-button"
						data-options="menu:'.theme-navigate-user-panel'">${sessionScope.admin.admin_name }</a>

					<div class="theme-navigate-user-panel">
						<dl>
							<dd>
								<img src="../themes/insdep/images/portrait86x86.png" width="86"
									height="86"> <b class="badge-prompt">${sessionScope.admin.admin_name }</b> 
									<span>id:&nbsp;${sessionScope.admin.admin_id }</span>
							</dd>
							<dt>
                        ...
                        <div class="easyui-accordion" data-options="border:false,fit:true">   
                            <div title="管理员管理">   
                                <ul class="easyui-datalist" data-options="border:false,fit:true">
                                    <li><a  id="addAdmin" href="#" rel="adminUserAdd.jsp">新增管理员</a></li>
                                    <li><a  id="adminList" href="#" rel="adminList.jsp">管理员列表</a></li>
                                </ul>  
                            </div>   
                            <div title="教师管理">   
                                <ul class="easyui-datalist" data-options="border:false,fit:true">
                                    <li><a  id="addTeacher" href="#" rel="teacherAdd.jsp">新增教师</a></li>
                                    <li><a  id="teacherList" href="#" rel="teacherList.jsp">教师列表</a></li>
                                </ul>      
                            </div>   
                            <div title="学生管理">   
                                <ul class="easyui-datalist" data-options="border:false,fit:true">
                                    <li><a  id="addStudent" href="#" rel="studentAdd.jsp">新增学生</a></li>
                                    <li><a  id="studentList" href="#" rel="studentList.jsp">学生列表</a></li>
                                </ul>      
                            </div>
                            <div title="选课计划">   
                                <ul class="easyui-datalist" data-options="border:false,fit:true">
                                    <li><a  id="cureentPlan" href="#" rel="currentPlan.jsp">当前计划</a></li>
                                    <li><a  id="addPlan" href="#" rel="addPlan.jsp">增加计划</a></li>
                                    <li><a  id="planList" href="#" rel="planList.jsp">计划列表</a></li>
                                    <li><a  id="planTime" href="#" rel="planTime.jsp">时间列表</a></li>
                                    <li><a  id="planCourse" href="#" rel="planCourse.jsp">课程列表</a></li>
                                </ul>      
                            </div>
                            <div title="选课记录">   
                                <ul class="easyui-datalist" data-options="border:false,fit:true">
                                    <li><a  id="searchRecord" href="#" rel="searchRecord.jsp">选课记录查询</a></li>
                                </ul>      
                            </div>
		...
		<div id="userWindow" class="easyui-window" title="修改资料" data-options="modal:true,collapsible:false,closed:true,maximizable:false,minimizable:false,resizable:false" style="width:550px;height:400px;padding:10px;">
			<div style="width: 400px; padding: 30px 60px;">
				<form id="ff" method="post"
					action="./adminServlet?method=userChange">
					<div style="margin-bottom: 20px">
						<input
							class="easyui-textbox theme-textbox-radius validatebox-readonly"
							readonly="readonly" value="${sessionScope.admin.admin_id }" name="id" id="id"
							style="width: 100%" data-options="label:'ID:'" />
					</div>
					<div style="margin-bottom: 20px">
						<input class="easyui-textbox theme-textbox-radius " id="name"
							name="name" value="${sessionScope.admin.admin_name }" style="width: 100%"
