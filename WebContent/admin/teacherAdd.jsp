...
<script type="text/javascript">
	...
	<div style="width: 400px; padding: 30px 60px;">
		<form id="ff" method="post" action="./adminServlet?method=teacherAdd">
			<div style="margin-bottom: 20px">
				<input class="easyui-textbox theme-textbox-radius " id="id" name="id" style="width: 100%"
					data-options="required:true, label:'教工编号:'" />
			</div>
			<div style="margin-bottom: 20px">
		...
		<div id="password-panel">
			<div style="margin-bottom: 20px" >
				<input class="easyui-passwordbox easyui-validatebox theme-textbox-radius" iconWidth="28" id="ipassword1" validType="length[8,16]" style="width: 100%" data-options="label:'密码:'" />
			</div>
			<div style="margin-bottom:20px" >
